...
import recoverPasswordTemplate from "~/utils/emailTemplate";
...
export const emailRouter = createTRPCRouter({
    sendPasswordEmail: publicProcedure
        ...
        .mutation(async ({ input, ctx }) => {
            ...
            const redirectURL = env.NODE_ENV === "production" ? `https://helenk.vercel.app/restablecer-contrasena/${token}` : `http://localhost:3000/restablecer-contrasena/${token}`;
